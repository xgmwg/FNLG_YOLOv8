...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'C:\Users\LX\Desktop\mango\ultralytics-8.0.227\weights\improve.pt')  # YOLOv8n模型
    model.predict(
        source=r'C:\Users\LX\Desktop\mango\ultralytics-8.0.227\VOCdevkit\Images\val\lasio_118.jpg',
        save=True,  # 保存预测结果
